    ...
    return BlocConsumer<AppCubit, AppStates>(
      ...
      builder: (context, state) {
        ...
        todayTasks.forEach((element) {
          ...
          } else if (hourParser(element['deadline']) < DateTime.now().hour ||
              element['currentStatus'] == 'Missed Deadline') {
            AppCubit.get(context).updateTaskCurrentStatus(
              ...
              children: [
                ...
                Container(
                  ...
                  child: ConditionalBuilder(
                    ...
                    builder: (context) =>
                        homeTaskListBuilder(tasks: inProgress),
